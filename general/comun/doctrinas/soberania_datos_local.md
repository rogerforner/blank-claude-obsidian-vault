...
- **[COMPROBACIÓN DEL TITULAR, no del agente] El ajuste de entrenamiento y retención de la propia cuenta.** En las cuentas de consumidor, permitir que los datos se usen para entrenar **extiende la retención a cinco años**, y el ajuste alcanza también al uso de la herramienta de línea de comandos desde esas cuentas — o sea, **también a las sesiones que trabajan sobre el vault**. No lo puede comprobar el agente: es una pantalla de ajustes de la cuenta. **Se mira una vez, se decide a propósito y se anota la decisión**, en vez de heredarla por defecto. *(Política del proveedor citada con fecha en el informe de superficies; reverificar antes de apoyarse en ella para una decisión importante.)*
