...
- Dos límites **independientes**: rolling de **5 h** + **semanal de 7 días**. Los weekly caps de Claude Code van **+50% hasta el 19-ago-2026, 23:59 PT** — **confirmado en fuente oficial el 12-ago-2026, y sin ninguna extensión documentada más allá de esa fecha** (se extendió dos veces; a la tercera, no consta). **Planifica como si terminara.**
