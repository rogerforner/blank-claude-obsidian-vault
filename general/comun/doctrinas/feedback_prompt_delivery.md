...
2. Escribe la **guía completa** (decisión, por qué esa y no las otras, verificaciones previas, matices, restricciones específicas) en un archivo **sobreescribible** (`tmp-otros-actual.md`) en la raíz de la carpeta de trabajo.
