...
├── memoria/                   doctrinas instaladas (copia) + doctrinas propias del asunto
...
> Pieza de catálogo `general/comun/doctrinas/`. v1.2 (2026-06-15): cuadro "Qué vive dónde (canónico)". v1.1 (2026-06-12): sección de cross-links entre contenedores acoplados. v1.0 (2026-06-09). Se instala por copia en `asuntos/<asunto>/memoria/`; no se hereda. Instancia canónica: `inicializador/plantilla-contenedor-asunto/`.
