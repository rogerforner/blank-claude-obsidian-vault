...
>
> **Caso medido (2026-08-14):** un asunto con un servidor de domótica conectado tenía **cero** denegaciones de sus herramientas, mientras su fichero de reglas declaraba puerta humana —en prosa— para reiniciar el servidor, desemparejar dispositivos o desarmar la alarma. **La exfiltración de datos y el histórico estaban protegidos; el mundo físico no.** La revisión que toca: listar las herramientas **irreversibles o que dejan un servicio caído**, denegarlas, y **conservar las de lectura y diagnóstico**, que son el trabajo diario. *(El caso difícil que hay que decidir a conciencia: una herramienta genérica de "llamar a un servicio" es a la vez la de uso normal y la que puede hacer lo irreversible.)*
