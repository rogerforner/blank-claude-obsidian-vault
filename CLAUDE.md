...
- **Memoria del vault.** Los hechos duraderos sobre el director y sobre cómo trabajar viven en `_meta/memoria/` (índice: `_meta/memoria/MEMORY.md`), **dentro del vault y versionados**, para que los lea cualquier agente. Consúltalos cuando la decisión lo pida; añade uno nuevo solo si es duradero y no derivable del repositorio.
