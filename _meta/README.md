...
- **[guia-configuracion-agentica-exportable.md](guia-configuracion-agentica-exportable.md)** — la capa de **configuración**, para llevarse a otro vault: los perfiles de permisos con el porqué de cada clave y sus salvedades de portabilidad, la **mensajería entre sesiones** completa (reparto por rol, qué no puede hacer un mensaje, y el límite de que solo alcanza sesiones vivas), las **superficies agénticas** con veredicto, las **cuatro trampas medidas** de las sesiones hijas, dónde está de verdad el gasto de contexto, **los prompts de arranque por rol** listos para copiar, y lo descartado con su umbral. **Complementa al informe del método: aquel explica las reglas, este cómo se configuran.**
