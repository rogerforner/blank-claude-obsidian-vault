...
5. **Vigilancia bajo demanda**: cuando el director lo pida, convertir la novedad en briefs para el chat web (`_meta/plantilla-brief-chat-web.md`), sintetizar y fundir lo que pase el gate ([[vigilancia_tecnologica_bajo_demanda]]).
