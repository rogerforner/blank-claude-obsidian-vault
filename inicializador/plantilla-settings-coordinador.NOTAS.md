...
- **`Write`/`Edit(//**/general/**)`** — el **catálogo en solo lectura** para los coordinadores de asunto. Es estructural: el catálogo lo mantiene el coordinador general del vault; un asunto **copia** lo que necesita a su `memoria/`, no edita la fuente ([`general/comun/README.md`](../general/comun/README.md)).
