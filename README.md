...
| [`general/comun/`](general/comun/README.md) | **Catálogo** transversal: las **doctrinas** del core con su índice, el **hook** de higiene, el tooling **local** de documentos y la resolución de problemas de la herramienta. Se **LEE**: no se copia al contenedor ni se hereda, y para un coordinador de asunto es **solo lectura** con barrera técnica. |
| [`general/comun/packs/codigo/`](general/comun/packs/codigo/README.md) | Pack **opcional**: las doctrinas que solo tienen sentido si un asunto incluye **software propio**. Si tu vault no toca software, ignóralo entero — el core no depende de él. |
