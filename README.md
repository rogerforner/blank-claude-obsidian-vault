...
6. **Instala en `asuntos/<asunto>/memoria/` solo las doctrinas que ese asunto necesite**, por copia. El catálogo `general/` se ve en solo lectura y **no se hereda**.
...
| [`general/comun/packs/codigo/`](general/comun/packs/codigo/README.md) | Pack **opcional**: 9 doctrinas que solo tienen sentido si un asunto incluye **software propio**. Si tu vault no toca software, ignóralo entero — el core no depende de él. |
